...
const string strMessageMagic = "RSCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.3 * 24 * 60 * 60; // RSCoin: 0.3 days
static const int64 nTargetSpacing = 120; // RSCoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal RSCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RSCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0d258aa6bb00c1866c1a6457a127870dfb72df65cf122ceb680bbcb1b557aa09");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Russia vows no Ukraine invasion";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xebfd53c69255fabf10195ef3758e9ec550b86f49768f23c8a3995eadc746341a"));
